...
// Simple benchmark for In-Memory Rate Limiter
// Purpose: Showcase performance of in-memory implementation
...
export default function () {
    ...
    const endpoint = `${BASE_URL}/api/v1/resource/${ALGORITHM}`;
